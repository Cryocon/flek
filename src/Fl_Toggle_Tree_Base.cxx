...
void Fl_Toggle_Tree_Base::draw_node(int depth, int cy, Fl_Toggle_Node_Base*) {
  fl_color(FL_BLACK);
...
Fl_Toggle_Node_Base* Fl_Toggle_Tree_Base::find(int fy, int& depth, int& ry) {
...
void Fl_Toggle_Tree_Base::draw(void) {
...
int Fl_Toggle_Tree_Base::s_compare_(void* a, void *b) {
...
int Fl_Toggle_Tree_Base::s_compare_reverse_(void* a, void *b) {
  Fl_Toggle_Node_Base* nodeA = *(Fl_Toggle_Node_Base**)a;
  Fl_Toggle_Node_Base* nodeB = *(Fl_Toggle_Node_Base**)b;
  return - s_node_compare_(nodeA, nodeB);
}

Fl_Toggle_Node_Base* Fl_Toggle_Tree_Base::sort_ (Fl_Toggle_Node_Base* start, int (*compar)(Fl_Toggle_Node_Base *, Fl_Toggle_Node_Base *),
...
Fl_Toggle_Node_Base* Fl_Toggle_Tree_Base::sort(Fl_Toggle_Node_Base* start, int (*compar) (Fl_Toggle_Node_Base *, Fl_Toggle_Node_Base*),
                       sort_order order ) {
  if (first_)
...
Fl_Toggle_Node_Base* Fl_Toggle_Tree_Base::sort_tree(Fl_Toggle_Node_Base* start, int (*compar)(Fl_Toggle_Node_Base *, Fl_Toggle_Node_Base*),
                            sort_order order) {
  if (first_)
...
void Fl_Toggle_Tree_Base::sort(int (*compar)(Fl_Toggle_Node_Base *, Fl_Toggle_Node_Base *),
                   sort_order order) {
  if (first_)
    first_ = top_ = sort(first_, compar, order);
}

void Fl_Toggle_Tree_Base::sort_tree(int (*compar)(Fl_Toggle_Node_Base *, Fl_Toggle_Node_Base *),
                        sort_order order) {
  if (first_)
    first_ = top_ = sort_tree(first_, compar, order);
}

void Fl_Toggle_Tree_Base::update_top(void) {
...
int Fl_Toggle_Tree_Base::total_height(Fl_Toggle_Node_Base* node) {
  int ret = 0;
  int depth = 1;
  while (node) {
    ret += height(node);
...
int Fl_Toggle_Tree_Base::height(Fl_Toggle_Node_Base*) {
  return 17;
}
